      ...
      <div className="flex w-full max-w-[1520px] flex-col items-center gap-10">
        ...
        <div className="flex w-full max-w-[803px] flex-col items-center gap-2 text-center">
          ...
          <div className="flex items-center gap-2">
            <Link
              href="/contact"
              className="inline-flex items-center gap-1.5 text-[#10b981] text-sm underline hover:text-[#059669] transition-colors"
            >
              See pricing
        ...
        <div className="w-full flex flex-wrap items-stretch justify-center gap-4 md:gap-6">
          {PLANS.map((plan) => (
            <div
              key={plan.name}
              className="flex min-w-[272px] max-w-sm flex-1 basis-[272px]"
            >
              <div className="relative flex h-full w-full flex-col justify-between rounded-2xl bg-[linear-gradient(180deg,#262626_0%,#0f0f0f_25%)] p-[1px]">
                <div className="absolute inset-[1px] rounded-[15px] bg-[#171717]" />
                {plan.highlight && (
                  <div className="pointer-events-none absolute inset-[1px] rounded-[15px] bg-[radial-gradient(131%_93%_at_100%_0%,rgba(16,185,129,0.7)_0%,transparent_100%)] opacity-10" />
                )}
                ...
                <div className="relative z-10 flex h-full flex-col gap-6 p-5">
                  ...
                  <div className="flex flex-col gap-4">
                    <div className="flex items-center gap-3">
                      ...
                      {plan.badge && (
                        <span className="rounded-lg bg-[#10b981] px-2.5 py-1 text-[11px] font-medium text-white">
                          {plan.badge}
                        </span>
                      )}
                    </div>
                  ...
                  <div className="mt-1 flex flex-col gap-2">
                    <ul className="flex flex-col gap-1.5">
                      {plan.features.map((feature) => (
                        ...
                        >
                          <Check className="mt-[2px] size-3.5 text-[#10b981]" />
                          <span>{feature}</span>
                        </li>
                      ))}
                    </ul>
                  ...
                  <div className="mt-4">
                    <Link
                      ...
                      className={
                        plan.highlight
                          ? "inline-flex h-10 w-full items-center justify-center rounded-lg bg-[linear-gradient(180deg,#10b981_0%,#059669_100%)] text-sm font-medium text-white shadow-lg shadow-black/25 transition hover:brightness-110"
                          : "inline-flex h-10 w-full items-center justify-center rounded-lg bg-[linear-gradient(180deg,#262626_0%,#0f0f0f_100%)] text-sm font-medium text-white shadow-lg shadow-black/25 transition hover:brightness-110"
                      }
                    >
                      {plan.name === "Starter"
                        ? "Request quote"
