...
import RevealOnScrollLoader from "@/components/RevealOnScrollLoader";
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body
        className={`${geistSans.variable} ${geistMono.variable} antialiased flex flex-col min-h-screen overflow-x-hidden overflow-y-auto`}
      >
        <Navbar />
        <main className="flex-1">{children}</main>
        <Footer />
        <RevealOnScrollLoader />
      </body>
    </html>
  );
}
